    ...
    !(function (a, factory) {
      ...
      return function (template, t, items, e) {
        ...
        var l = function () {
          ...
          Ht = function () {
            for (var t in zt) if (zt.hasOwnProperty(t)) Pt(t);
          },
              ...
              if (!u && !f) {
                ...
                if (
                  ...
                  A = setInterval(function () {
                    if (!Rt && !le && !ye && C === n.currItem.initialZoomLevel)
                      n.updateSize();
                  }, 1e3);
